...
# Creamos la vm
call('virt-install --connect qemu:///system --name cdps --memory 2048 --import cdps-vm-base-p1.qcow2 \\'
     '--vcpus=2 --os-type linux --network bridge=vibr0 --keymap es', shell=True)
